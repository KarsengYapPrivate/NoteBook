import { _decorator, Component, Enum, math, Node, Vec2, view, screen, Label, ResolutionPolicy, v2, sys, log, Details, director, Canvas } from 'cc';
...
export class ResponsiveScript extends Component {
    ...
    @property(Node) canves : Node = null;
    ...
    OnViewOrientationChangedHandler () {
        ...
        if (this.currentOrientation != orientation) {
            ...
            this.canves.getComponent(Canvas).alignCanvasWithScreen = false;
            this.canves.getComponent(Canvas).alignCanvasWithScreen = true;
        }
    }
