// README
// In cocoscreator v3.8.1, just place this file within the project and is then able to import and use, example below:
// 
// import {default as Encryption} from '../Utils/Encryption.js';
// let a = Encryption.encrypt("aaa");
// let b = Encryption.decrypt(a);
// console.log(a) ==> <encrypted string (random chars)>
// console.log(b) ==> "aaa"
...
var ecrypt = (function () {
	...
	// in cocos 3.8.1 module exports have to place inside function scope
	module.exports = {encrypt, decrypt};

	// The below return statement is copy from cocos 2.4.6 but does not work for cocos 3.8.1
	// return {
	// 	encrypt: encrypt,
	// 	decrypt: decrypt
	// }
...
// The below module.exports is copy from cocos 2.4.6 but does not work for cocos 3.8.1
